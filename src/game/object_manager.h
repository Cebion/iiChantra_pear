...
/* Функция, уничтожающая содержимое контейнера. */
...
/* Функция, возвращающая итератор в начало */
...
// Функция, добавляющая новую пару ключ-значение в контейнер. Ключ обязательно должен быть больше, 
// чем любой ключ в дереве. В функции исключены некоторые проверки, котрые есть в LSQ_InsertElement.
